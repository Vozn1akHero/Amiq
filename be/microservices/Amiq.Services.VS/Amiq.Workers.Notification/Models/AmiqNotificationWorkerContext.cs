...
{
    public partial class AmiqNotificationWorkerContext : DbContext
    {
        public AmiqNotificationWorkerContext()
        {
        }

        public AmiqNotificationWorkerContext(DbContextOptions<AmiqNotificationWorkerContext> options)
            : base(options)
        {
        }
