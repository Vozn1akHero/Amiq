...
mkdir temp
cd temp
mkdir Amiq.DataAccess.Models
cd Amiq.DataAccess.Models
dotnet new webapi
Write-Host "Done creating temp project";
Write-Host "Scaffolding dbcontext into project";
dotnet add package Microsoft.EntityFrameworkCore.Design
dotnet add package Microsoft.EntityFrameworkCore.SqlServer
dotnet ef dbcontext scaffold "data source=localhost;Database=Amiq;MultipleActiveResultSets=True;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer --output-dir Models --project Amiq.DataAccess.Models.csproj
