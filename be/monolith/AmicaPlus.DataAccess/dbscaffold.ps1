...
dotnet ef dbcontext scaffold "data source=.\SQLEXPRESS;Database=AmicaPlus;MultipleActiveResultSets=True;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer --output-dir Models --project temp.csproj
